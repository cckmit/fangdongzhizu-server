package com.data.common.minio.utils;
...
public class FileTypeUtils {
    ...
    public static String getFileType(MultipartFile multipartFile) {
        ...
        try {
            ...
            if (type.equalsIgnoreCase("doc") || type.equalsIgnoreCase("docx") || type.equalsIgnoreCase("ppt") || type.equalsIgnoreCase("pptx") || type.equalsIgnoreCase("xls") || type.equalsIgnoreCase("xlsx") || type.equalsIgnoreCase("zip") || type.equalsIgnoreCase("jar")) {
