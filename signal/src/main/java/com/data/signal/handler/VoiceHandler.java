...
@Slf4j
public class VoiceHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, TextWebSocketFrame frame) throws Exception {
        ...
        if (transmit != null && transmit.getAuth() && "voice".equals(transmit.getType())) {
            ...
            System.out.println("--------------> 这是我想看的 [语音] 传输数据:" + transmit.toString());
